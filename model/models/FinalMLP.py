...
from model.BasiclLayer import FeaturesEmbedding, MultiLayerPerceptron, FeaturesLinear, BasicCTR, MLP_Block

class FinalMLP(BasicCTR):
    def __init__(self, 
                 field_dims,
                 embed_dim,
                 ...
                 **kwargs):
        super().__init__(field_dims, embed_dim, **kwargs)
